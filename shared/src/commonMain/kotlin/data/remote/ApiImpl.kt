...
class ApiImpl: ApiInterface {
    ...
    override suspend fun nowPlayingMovieList(page: Int): BaseModel {
        return client.get {
            nowPlayingMovie(page)
        }.body()
    }

    override suspend fun popularMovieList(page: Int): BaseModelV2 {
        return client.get{
            popularMovie(page)
        }.body()
    }

    override suspend fun topRatedMovieList(page: Int): BaseModelV2 {
        return client.get{
            topRatedMovie(page)
        }.body()
    }

    override suspend fun upcomingMovieList(page: Int): BaseModel {
        return client.get{
            upcomingMovie(page)
        }.body()
    }
